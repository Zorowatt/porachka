...
const dataBase = require('./handlers/helpers/dataBase');
const randome=require('./handlers/helpers/helpersCommon');
...
server.unifiedServer = function(req,res){
  ...
  req.on('end', function() {
    ...
    dataBase.create('requests',randome.createRandomString(5),data,function(err){
 ...
 server.processHandlerResponse = function(res,method,trimmedPath,statusCode,payload,contentType){
  ...
  if(contentType == 'html'){
    ...
    //res.setHeader('content-language','bg');
